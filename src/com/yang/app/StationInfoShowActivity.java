...
public class StationInfoShowActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Station station = (Station) intent
		...
		if (routeList != null) {
			...
			SimpleAdapter adapter = new SimpleAdapter(this, listItems,
					R.layout.item_station_info, new String[] { "busName",
							"time", "piaojia" }, new int[] {
							R.id.station_info_route_name, R.id.time,
							R.id.piaojia });
			// 初始化listView
			...
			Toast toast = Toast.makeText(getApplicationContext(), "该站点不存在！",
					Toast.LENGTH_SHORT);
